...
$.ajax({url: 'http://staging.eimpressive.com/slim-four/dashinprogress.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({url: 'http://staging.eimpressive.com/slim-four/dashverified.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'verified');
$.ajax({url: 'http://staging.eimpressive.com/slim-four/dash_not_verified.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,

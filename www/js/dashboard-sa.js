...
$.ajax({url: 'http://staging.eimpressive.com/slim_four_rips/dashnewveri.php?region='+region,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({url: 'http://staging.eimpressive.com/slim_four_rips/dashinprogress.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
$.ajax({url: 'http://staging.eimpressive.com/slim_four_rips/dashverified.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'verified');
$.ajax({url: 'http://staging.eimpressive.com/slim_four_rips/dash_not_verified.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#new').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,
...
//alert(region+'verified');
$.ajax({url: 'http://staging.eimpressive.com/slim_four_rips/completed.php?region='+region+"&user_id="+user_id+"&state="+state,
  data:$('#newt').serialize(),
  type: 'post',                   
  async: 'true',
  crossDomain: true,

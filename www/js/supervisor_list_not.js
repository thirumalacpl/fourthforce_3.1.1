...
var lis='<li class="ui-li-has-thumb ui-first-child li_list"><a href="#" onclick="callnextpnotveri('+a+')" class="waves-effect waves-button ui-btn ui-btn-icon-right ui-icon-carat-r  waves-button waves-effect waves-button"><img src="images/mobile/education-icon.png" class="li_imgs_1"><h2 class="li_h2">Subject First_Name : '+super_obj.First_Name+'  '+super_obj.Last_Name+'</h2 class="li_h2"><p class="li_p">Type : '+super_obj.verification_for+'</p><p class="li_p">Taskname : '+super_obj.qualification_name+'</p><p class="li_p ">Posted On : <span class="listrejectcolora">'+subco_status+'</span></p><span class="li_span">SH Approved On : '+date+'</span><b class="li_b_1">Ref.No:'+super_obj.Ref_no+'</b></a></li>'
